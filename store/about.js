...
export const aboutme = [
  {
    name: 'Name', value: 'Amit Kumar Sharma',
  },
  {
    name: 'Days Lived', value: daysLivedString.value,
  },
  {
    name: 'Location', value: 'Ranchi, Jharkhand, India',
  },
  {
    name: 'Summary', value: `A ${daysLived.year} year young, self-motivated tech enthusiast, full-stack developer and a ML enthusiast. 
                            I spend my time learning & experimenting new technologies.`,
  },
  {
    name: '', value: `Over the last two years, I've gained expertise in modern tech stacks like React, Next, Vue, NodeJS and PostgreSQL.
