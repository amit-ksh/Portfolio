 ...
 */
export const diffDate = (year: number, month: number, date: number): { year: number, month: number, date: number } => {
  ...
  let y: number = diffDate.getFullYear() - 1970 // date starts from 1 Jan 1970
